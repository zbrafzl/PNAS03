...
namespace Prp.Model
{
    ...
    public partial class DbPrpEntities : DbContext
    {
        ...
        public virtual DbSet<tvwApplicantNursing> tvwApplicantNursings { get; set; }
        ...
        public virtual int spApplicantAddUpdateInfo(Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, string fatherName, Nullable<int> genderId, Nullable<int> disableId, Nullable<System.DateTime> dob, Nullable<System.DateTime> pmdcExpiryDate, Nullable<System.DateTime> mbbsPassingDate, Nullable<int> countryIdDegreePassing, Nullable<int> dualNationalityType, Nullable<int> countryId, Nullable<int> districtId, string districtName, Nullable<int> domicileProvinceId, Nullable<int> domicileDistrictId, string address, string cnicNo, Nullable<System.DateTime> cnicExpiryDate, string cnicPicFront, string cnicPicBack, string domicilePicFront, string domicilePicBack, string pic, string disableImage, string pncPicFront, string pncPicBack, string medicalFitnessCertificate, Nullable<System.DateTime> pncExpiryDate, Nullable<System.DateTime> generalNursingPassingDate, Nullable<System.DateTime> midWiferyPassingDate, Nullable<System.DateTime> genericBSNPassingDate, Nullable<int> meritalStatus )
        {
            ...
            var pncPicFrontParameter = pncPicFront != null ?
                new ObjectParameter("pncPicFront", pncPicFront) :
                new ObjectParameter("pncPicFront", typeof(string));

            var pncPicBackParameter = pncPicBack != null ?
                new ObjectParameter("pncPicBack", pncPicBack) :
                new ObjectParameter("pncPicBack", typeof(string));

            var medicalFitnessCertificateParameter = medicalFitnessCertificate != null ?
                new ObjectParameter("medicalFitnessCertificate", medicalFitnessCertificate) :
                new ObjectParameter("medicalFitnessCertificate", typeof(string));

            var pncExpiryDateParameter = pncExpiryDate.HasValue ?
                new ObjectParameter("pncExpiryDate", pncExpiryDate) :
                new ObjectParameter("pncExpiryDate", typeof(System.DateTime));

            var generalNursingPassingDateParameter = generalNursingPassingDate.HasValue ?
                new ObjectParameter("generalNursingPassingDate", generalNursingPassingDate) :
                new ObjectParameter("generalNursingPassingDate", typeof(System.DateTime));

            var midWiferyPassingDateParameter = midWiferyPassingDate.HasValue ?
                new ObjectParameter("midWiferyPassingDate", midWiferyPassingDate) :
                new ObjectParameter("midWiferyPassingDate", typeof(System.DateTime));

            var genericBSNPassingDateParameter = genericBSNPassingDate.HasValue ?
                new ObjectParameter("genericBSNPassingDate", genericBSNPassingDate) :
                new ObjectParameter("genericBSNPassingDate", typeof(System.DateTime));


            var meritalStatusParameter = meritalStatus.HasValue ?
               new ObjectParameter("meritalStatus", meritalStatus) :
               new ObjectParameter("meritalStatus", typeof(int));


            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spApplicantAddUpdateInfo", inductionIdParameter, phaseIdParameter, applicantIdParameter, fatherNameParameter, genderIdParameter, disableIdParameter, dobParameter, pmdcExpiryDateParameter, mbbsPassingDateParameter, countryIdDegreePassingParameter, dualNationalityTypeParameter, countryIdParameter, districtIdParameter, districtNameParameter, domicileProvinceIdParameter, domicileDistrictIdParameter, addressParameter, cnicNoParameter, cnicExpiryDateParameter, cnicPicFrontParameter, cnicPicBackParameter, domicilePicFrontParameter, domicilePicBackParameter, picParameter, disableImageParameter, pncPicFrontParameter, pncPicBackParameter, medicalFitnessCertificateParameter, pncExpiryDateParameter, generalNursingPassingDateParameter, midWiferyPassingDateParameter, genericBSNPassingDateParameter, meritalStatusParameter);
        }
        ...
        public virtual int spApplicantDegreeMarksAddUpdate(Nullable<int> degreeMarksId, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> graduateTypeId, Nullable<int> year, Nullable<double> totalMarks, Nullable<double> obtainMarks, Nullable<int> attempt, string imageDMC)
        {
        ...
        public virtual int spApplicantDegreeMarksAddUpdateAdmin(Nullable<int> degreeMarksId, Nullable<int> inductionId, Nullable<int> phaseId, Nullable<int> applicantId, Nullable<int> graduateTypeId, Nullable<int> year, Nullable<double> totalMarks, Nullable<double> obtainMarks, Nullable<int> attempt, string imageDMC, Nullable<int> adminId)
        {
            var degreeMarksIdParameter = degreeMarksId.HasValue ?
                new ObjectParameter("degreeMarksId", degreeMarksId) :
                new ObjectParameter("degreeMarksId", typeof(int));
        ...
        public virtual ObjectResult<spApplicantRegister_Result> spApplicantRegister(string name, string pmdcNo, string pncNo, string emailId, string password, string contactNumber, Nullable<int> network, Nullable<int> levelId, Nullable<int> facultyId, string pic, Nullable<int> inductionId, Nullable<int> adminId)
        {
            ...
            var pncNoParameter = pncNo != null ?
                new ObjectParameter("pncNo", pncNo) :
                new ObjectParameter("pncNo", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spApplicantRegister_Result>("spApplicantRegister", nameParameter, pmdcNoParameter, pncNoParameter, emailIdParameter, passwordParameter, contactNumberParameter, networkParameter, levelIdParameter, facultyIdParameter, picParameter, inductionIdParameter, adminIdParameter);
        }
        ...
        public virtual ObjectResult<spEmailProcessGetByApplicantAndType_Result> spEmailProcessGetByApplicantAndType(Nullable<int> applicantId, Nullable<int> typeId)
        {
            var applicantIdParameter = applicantId.HasValue ?
                new ObjectParameter("applicantId", applicantId) :
                new ObjectParameter("applicantId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spEmailProcessGetByApplicantAndType_Result>("spEmailProcessGetByApplicantAndType", applicantIdParameter, typeIdParameter);
        }
        ...
        public virtual ObjectResult<spJoiningApplicantByHospitalSearch_Result> spJoiningApplicantByHospitalSearch(Nullable<int> pageNum, Nullable<int> top, Nullable<int> userId, Nullable<int> specialityId, Nullable<int> hospitalId, Nullable<int> attachStatusId, string search)
        {
            var pageNumParameter = pageNum.HasValue ?
                new ObjectParameter("pageNum", pageNum) :
                new ObjectParameter("pageNum", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spJoiningApplicantByHospitalSearch_Result>("spJoiningApplicantByHospitalSearch", pageNumParameter, topParameter, userIdParameter, specialityIdParameter, hospitalIdParameter, attachStatusIdParameter, searchParameter);
        }
        ...
        public virtual int spApplicantLoginNursing(string emailId, string password)
        {
            var emailIdParameter = emailId != null ?
                new ObjectParameter("emailId", emailId) :
                new ObjectParameter("emailId", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spApplicantLoginNursing", emailIdParameter, passwordParameter);
        }
    }
}
